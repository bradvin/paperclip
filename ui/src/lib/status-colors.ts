...
export const issueStatusIcon: Record<string, string> = {
  ...
  testing: "text-cyan-600 border-cyan-600 dark:text-cyan-400 dark:border-cyan-400",
  human_review: "text-violet-600 border-violet-600 dark:text-violet-400 dark:border-violet-400",
  rework: "text-orange-600 border-orange-600 dark:text-orange-400 dark:border-orange-400",
  merging: "text-teal-600 border-teal-600 dark:text-teal-400 dark:border-teal-400",
...
export const issueStatusText: Record<string, string> = {
  ...
  human_review: "text-violet-600 dark:text-violet-400",
  rework: "text-orange-600 dark:text-orange-400",
  merging: "text-teal-600 dark:text-teal-400",
...
export const statusBadge: Record<string, string> = {
  ...
  testing: "bg-cyan-100 text-cyan-700 dark:bg-cyan-900/50 dark:text-cyan-300",
  human_review: "bg-violet-100 text-violet-700 dark:bg-violet-900/50 dark:text-violet-300",
  rework: "bg-orange-100 text-orange-700 dark:bg-orange-900/50 dark:text-orange-300",
  merging: "bg-teal-100 text-teal-700 dark:bg-teal-900/50 dark:text-teal-300",
