...
const statusOrder = ["in_progress", "rework", "merging", "todo", "backlog", "in_review", "blocked", "done", "cancelled"];
...
const quickFilterPresets = [
  ...
  { label: "Active", statuses: ["todo", "in_progress", "in_review", "rework", "merging", "blocked"] },
